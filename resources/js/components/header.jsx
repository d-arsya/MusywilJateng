        ...
        <footer className="bg-emerald-900 py-4 text-white">
            <div className="container mx-auto px-4">
                <div className="text-center">
                    <p className="mb-2 text-emerald-200">© 2025 Musyawarah Wilayah III Hidayatullah</p>
                    <p className="text-sm text-emerald-300">Website Official Musyawarah Wilayah III Hidayatullah Kalimantan Utara</p>
                </div>
            </div>
        </footer>
    );
