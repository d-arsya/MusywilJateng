...
export default function AuthLayout({ children }) {
    return (
        <div className="flex min-h-screen flex-col bg-gray-50">
            {/* Main content */}
            <main className="mx-auto w-full max-w-xs flex-1 pb-16">{children}</main>
            ...
            <footer className="fixed bottom-0 left-0 z-50 w-full border-t border-gray-200 bg-white shadow-sm">
                <div className="relative flex h-16 items-center justify-around">
                    ...
                    {/* Center Logo */}
                    <div className="absolute -top-6 left-1/2 flex h-12 w-12 -translate-x-1/2 items-center justify-center rounded-full border border-gray-200 bg-white shadow-md">
                        <img
